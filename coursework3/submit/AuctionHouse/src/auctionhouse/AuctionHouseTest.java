...
public class AuctionHouseTest {
    ...
    //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    private static void assertNO_SALE(Status status) {
  ...
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    @Test
    public void testCloseAuctionWithNo_Sale() {
    	logger.info(makeBanner("testCloseAuctionWithNo_Sale"));
    	runStory(6);
    	assertNO_SALE(house.closeAuction("@Auctioneer1", 1));
    	
    }
    
    @Test
    public void testCloseAuctionWithError() {
    	logger.info(makeBanner("testCloseAuctionWithNo_Sale"));
    	runStory(1);
    ...
    @Test
    public void testMakeBidWithError() {
    ...
    @Test
    public void testOpenAuctionWithError() {
    	runStory(1);
    	assertError(house.openAuction("Auctioneer1", "@Auctioneer1", 1));
    }
    
    @Test
    public void testAddLotError() {
    	runStory(2);
    	assertError(house.addLot("SellerY", 2, "iPhone", new Money("200.00")));
    }
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
